...
void trilTree::Loop(){
	...
	/*
	const unsigned nSamples = 54;
	const unsigned nSamples_eff = 28;
	const unsigned nSig = 22;
	...
	const TString fileList[nSamples] = {"data_combined_trilepton.root", 
										"HeavyNeutrino_M1_e.root", "HeavyNeutrino_M2_e.root", "HeavyNeutrino_M5_e.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-6_V-0.00316_e_prompt.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-7_V-0.00316_e_prompt.root",
//new corrected signal
"../unskimmedSignal/HeavyNeutrino_M5_V0p00527_e.root",
"../unskimmedSignal/HeavyNeutrino_M6_V0p00451_e.root",

"HeavyNeutrino_M10_e.root", "HeavyNeutrino_M20_e.root", "HeavyNeutrino_M30_e.root", "HeavyNeutrino_M40_e.root", "HeavyNeutrino_M50_e.root", "HeavyNeutrino_M60_e.root", "HeavyNeutrino_M80_e.root", "HeavyNeutrino_M100_e.root", "HeavyNeutrino_M130_e.root", "HeavyNeutrino_M150_e.root", "HeavyNeutrino_M200_e.root", "HeavyNeutrino_M400_e.root", "HeavyNeutrino_M600_e.root", "HeavyNeutrino_M800_e.root", "HeavyNeutrino_M1000_e.root",
	...
	const double xSections[nSamples - 1] = { 2.617e-01*couplingCorrection*lowMCoupling, 2.607e-01*couplingCorrection*lowMCoupling, 2.600e-01*couplingCorrection*lowMCoupling,
2.618e-02*couplingCorrection*lowMCoupling*10, //m = 6 GeV
2.601e-02*couplingCorrection*lowMCoupling*10, //m = 7 GeV
//cross sections for new corrected signal
7.226e-02*couplingCorrection*lowMCoupling*10*(0.00316*0.00316)/(0.00527*0.00527),
5.293e-02*couplingCorrection*lowMCoupling*10*(0.00316*0.00316)/(0.00451*0.00451),

2.571e-01*couplingCorrection*lowMCoupling, 2.381e-01*couplingCorrection*lowMCoupling, 2.088e-01*couplingCorrection*lowMCoupling, 1.677e-01*couplingCorrection*lowMCoupling, 1.190e-01*couplingCorrection*lowMCoupling, 6.715e-02*couplingCorrection*lowMCoupling, 1.242e-02*couplingCorrection*lowMCoupling*10, 5.139e-04*couplingCorrection*highMCoupling, 1.442e-04*couplingCorrection*highMCoupling, 7.833e-05*couplingCorrection*highMCoupling, 2.473e-05*couplingCorrection*highMCoupling, 1.748e-06*couplingCorrection*highMCoupling, 3.487e-07*couplingCorrection*highMCoupling, 1.027e-07*couplingCorrection*highMCoupling, 3.563e-08*couplingCorrection*highMCoupling, 
...
"m_{N} = 10 GeV", "m_{N} = 20 GeV", "m_{N} = 30 GeV", "m_{N} = 40 GeV", "m_{N} = 50 GeV", "m_{N} = 60 GeV", "m_{N} = 80 GeV", "m_{N} = 100 GeV", "m_{N} = 130 GeV", "m_{N} = 150 GeV", "m_{N} = 200 GeV", "m_{N} = 400 GeV", "m_{N} = 600 GeV", "m_{N} = 800 GeV", "m_{N} = 1000 GeV",  									 
	...
	*/
	const unsigned nSamples = 66;
	const unsigned nSamples_eff = 32;
	const unsigned nSig = 26;
	const double lowMCoupling = 0.00001;
	const double highMCoupling = 0.01;
	const double couplingCorrection = 10000;
	//~~~~~~~~ background normalizations~~~~~~~~~~~~~~~~~~~~
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	const TString fileList[nSamples] = {"data_combined_trilepton.root", 
										"HeavyNeutrino_M1_e.root", "HeavyNeutrino_M2_e.root", 
"../unskimmedSignal/HeavyNeutrino_trilepton_M-3_V-0.0245_e_prompt.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-4_V-0.01_e_prompt.root", 
"HeavyNeutrino_M5_e.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-6_V-0.00316_e_prompt.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-7_V-0.00316_e_prompt.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-8_V-0.00328876176_e_prompt.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-9_V-0.00244991552_e_prompt.root",
"HeavyNeutrino_M10_e.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-11_V-0.00148345941_e_prompt.root",
"../unskimmedSignal/HeavyNeutrino_trilepton_M-12_V-0.0011934501_e_prompt.root",

"HeavyNeutrino_M20_e.root", "HeavyNeutrino_M30_e.root", "HeavyNeutrino_M40_e.root", "HeavyNeutrino_M50_e.root", "HeavyNeutrino_M60_e.root", 

"HeavyNeutrino_M80_e.root", "HeavyNeutrino_VBF_M-80_e.root",
"HeavyNeutrino_M100_e.root", "HeavyNeutrino_VBF_M-100_e.root",
"HeavyNeutrino_M130_e.root", "HeavyNeutrino_VBF_M-130_e.root",
"HeavyNeutrino_M150_e.root", "HeavyNeutrino_VBF_M-150_e.root",
"HeavyNeutrino_M200_e.root",
"HeavyNeutrino_M400_e.root", "HeavyNeutrino_VBF_M-400_e.root",
"HeavyNeutrino_M600_e.root", "HeavyNeutrino_VBF_M-600_e.root",
"HeavyNeutrino_M800_e.root", "HeavyNeutrino_VBF_M-800_e.root",
"HeavyNeutrino_M1000_e.root", "HeavyNeutrino_VBF_M-1000_e.root",

"ZZTo4L.root",  "GluGluToZZTo4mu.root", "GluGluToZZTo4e.root", "GluGluToZZTo4tau.root", "GluGluToZZTo2e2mu.root", "GluGluToZZTo2e2tau.root", "GluGluToZZTo2mu2tau.root", 	"VHToNonbb.root", "GluGluHToZZTo4L_M125.root", "VBF_HToZZTo4L_M125.root", "WWG.root","WWW.root", "WWZ.root", "WWTo2L2Nu_DoubleScattering.root", "WWTo2L2Nu.root",  "ZZZ.root", "WZTo3LNu_mllmin01.root", "TTGJets.root","ZGTo2LG.root", "WGToLNuG.root", "TGJets.root", "TTJets_DiLept.root", "TTJets_SingleLeptFromTbar.root", "TTJets_SingleLeptFromT.root", "DYJetsToLL_M10to50.root", "DYJetsToLL_M50.root", "ttHToNonbb.root", "TTWJetsToLNu.root", "TTZToLLNuNu.root", "TTZToLL_M1to10.root",  "TTTT.root"};
	
	const double xSections[nSamples - 1] = { 2.617e-01*couplingCorrection*lowMCoupling, 2.607e-01*couplingCorrection*lowMCoupling,
1.57*couplingCorrection*lowMCoupling*(0.01*0.01)/(0.0245*0.0245), //3 GeV
2.596e-01*couplingCorrection*lowMCoupling, //4 GeV
2.600e-01*couplingCorrection*lowMCoupling, //5 GeV
2.618e-02*couplingCorrection*lowMCoupling*10, //m = 6 GeV
2.601e-02*couplingCorrection*lowMCoupling*10, //m = 7 GeV
2.784e-02/(0.00328876176*0.00328876176)*lowMCoupling, //8 GeV
1.549e-02/(0.00244991552*0.00244991552)*lowMCoupling, //9 GeV
2.571e-01*couplingCorrection*lowMCoupling, //10 GeV
5.614e-03/(0.00148345941*0.00148345941)*lowMCoupling, //11 GeV
3.614e-03/(0.0011934501*0.0011934501)*lowMCoupling, //12 GeV

2.381e-01*couplingCorrection*lowMCoupling, 2.088e-01*couplingCorrection*lowMCoupling, 1.677e-01*couplingCorrection*lowMCoupling, 1.190e-01*couplingCorrection*lowMCoupling, 6.715e-02*couplingCorrection*lowMCoupling, 

1.242e-02*couplingCorrection*lowMCoupling*10, 1.824e-05*couplingCorrection*lowMCoupling*10,//80 GeV
5.139e-04*couplingCorrection*highMCoupling,  2.641e-06*couplingCorrection*highMCoupling,//100 GeV
1.442e-04*couplingCorrection*highMCoupling,  1.821e-06*couplingCorrection*highMCoupling,//130 GeV
7.833e-05*couplingCorrection*highMCoupling,  1.508e-06*couplingCorrection*highMCoupling,//150 GeV
2.473e-05*couplingCorrection*highMCoupling,  //200 GeV 
1.748e-06*couplingCorrection*highMCoupling,  3.647e-07*couplingCorrection*highMCoupling,//400 GeV
3.487e-07*couplingCorrection*highMCoupling,  1.709e-07*couplingCorrection*highMCoupling,//600 GeV
1.027e-07*couplingCorrection*highMCoupling,  8.993e-08*couplingCorrection*highMCoupling,//800 GeV
3.563e-08*couplingCorrection*highMCoupling,  5.132e-08*couplingCorrection*highMCoupling,//1000 GeV
...
"m_{N} = 20 GeV", "m_{N} = 30 GeV", "m_{N} = 40 GeV", "m_{N} = 50 GeV", "m_{N} = 60 GeV", "m_{N} = 80 GeV", "m_{N} = 100 GeV", "m_{N} = 130 GeV", "m_{N} = 150 GeV", "m_{N} = 200 GeV", "m_{N} = 400 GeV", "m_{N} = 600 GeV", "m_{N} = 800 GeV", "m_{N} = 1000 GeV",
	...
	for(unsigned sam = 0, effsam = 0; sam < nSamples; ++sam, ++effsam){
        ...
        for(Long64_t it = 0; it < nEntries; ++it){
			...
			if(tril_flavorComb(ind, _flavors, lCount) > 1) continue; //Select only 2 or more electrons!
			//MC prompt matching
			if(effsam  > nSig){
...
"m20", "m30", "m40", "m50", "m60", "m80", "m100", "m130", "m150", "m200", "m400", "m600", "m800", "m1000"};
	...
	for(unsigned cat = 0; cat < nCat; ++cat){
		...
		for(unsigned b = 1; b < yields[cat][nSig + 1]->GetNbinsX() + 1; ++b){
			...
			std::cout << "electron search region = " << binCountio << std::endl;
	...
	totalDataYield->SetBinErrorOption(TH1::kPoisson);
	makePaperPlotHNL(totalDataYield, totalBkgYields, totalBkgError, backGroundNames, nBkg, "3 leptons, #geq 2 electrons", "allSR_ElectronCoupling");
}
