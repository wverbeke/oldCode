...
void trilTree::Loop(){
	...
	const TString fileList[nSamples] = {"data_combined_trilepton.root", 
										"HeavyNeutrino_M1_mu.root", "HeavyNeutrino_M2_mu.root", "HeavyNeutrino_M5_mu.root", "HeavyNeutrino_M10_mu.root", "HeavyNeutrino_M20_mu.root", "HeavyNeutrino_M30_mu.root", "HeavyNeutrino_M40_mu.root", "HeavyNeutrino_M50_mu.root", "HeavyNeutrino_M60_mu.root", "HeavyNeutrino_M80_mu.root", "HeavyNeutrino_M100_mu.root", "HeavyNeutrino_M130_mu.root", "HeavyNeutrino_M150_mu.root", "HeavyNeutrino_M200_mu.root", "HeavyNeutrino_M400_mu.root", "HeavyNeutrino_M600_mu.root", "HeavyNeutrino_M800_mu.root", "HeavyNeutrino_M1000_mu.root",
	...
	const double xSections[nSamples - 1] = {  2.614e-01*couplingCorrection*lowMCoupling, 2.614e-01*couplingCorrection*lowMCoupling, 2.600e-01*couplingCorrection*lowMCoupling, 2.550e-01*couplingCorrection*lowMCoupling, 2.366e-01*couplingCorrection*lowMCoupling, 2.076e-01*couplingCorrection*lowMCoupling, 1.664e-01*couplingCorrection*lowMCoupling, 1.177e-01*couplingCorrection*lowMCoupling, 6.675e-02*couplingCorrection*lowMCoupling, 1.237e-02*couplingCorrection*lowMCoupling*10, 5.160e-04*couplingCorrection*highMCoupling, 1.434e-04*couplingCorrection*highMCoupling, 7.809e-05*couplingCorrection*highMCoupling, 2.463e-05*couplingCorrection*highMCoupling, 1.730e-06*couplingCorrection*highMCoupling, 3.470e-07*couplingCorrection*highMCoupling, 1.020e-07*couplingCorrection*highMCoupling, 3.659e-08*couplingCorrection*highMCoupling, 
	...
	for(unsigned sam = 0, effsam = 0; sam < nSamples; ++sam, ++effsam){
        ...
        for(Long64_t it = 0; it < nEntries; ++it){
			...
			if(tril_flavorComb(ind, _flavors, lCount) != 2 && tril_flavorComb(ind, _flavors, lCount) != 3) continue;
